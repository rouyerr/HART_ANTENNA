...
float lat_test = 44.56807; // Example latitude for testing
float lon_test = 123.27401; // Example longitude for testing
float alt_test = 400; // Example altitude for testing
